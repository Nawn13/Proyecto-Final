...
<body>
    ...
    <header>
        ...
        <h1 id="h1head">DPS Industry</h1>
            ...
            <div class="head_div">
                <ul class="head_list"> <li> &nbsp;Contactanos</li> <b><li> &nbsp;Sobre nosotros</li></b> <li> <a href="index.html">&nbsp;Castellano</a></li> <li> <a href="indexcat.html">&nbsp;Catalan</a></li> <li><a href="indexing.html">&nbsp;Ingles</a></li><li><a href="login.php"><button id="Boton" name="submit" type="submit"> LOGIN</button></a></li></ul>
            </div>
